...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame.setGeometry(QtCore.QRect(30, 80, 130, 131))
        ...
        self.widget.setGeometry(QtCore.QRect(30, 50, 571, 21))
        self.widget.setObjectName("widget")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.widget)
        self.horizontalLayout.setContentsMargins(0, 0, -1, -1)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.lbldescriptioncamecorder = QtWidgets.QLabel(self.widget)
        ...
        self.lblfree = QtWidgets.QLabel(self.widget1)
        self.lblfree.setObjectName("lblfree")
        self.gridLayout.addWidget(self.lblfree, 1, 1, 1, 1)
        self.lblused = QtWidgets.QLabel(self.widget1)
        self.lblused.setObjectName("lblused")
        self.gridLayout.addWidget(self.lblused, 2, 1, 1, 1)
        self.widget2 = QtWidgets.QWidget(self.centralwidget)
        self.widget2.setGeometry(QtCore.QRect(30, 220, 573, 533))
        ...
        self.lbltotal = QtWidgets.QLabel(self.widget2)
        ...
        self.lnecapturename = QtWidgets.QLineEdit(self.widget2)
        ...
        self.progressbaracquisition = QtWidgets.QProgressBar(self.widget2)
        ...
        self.btnrecordmpeg = QtWidgets.QPushButton(self.widget2)
        ...
        self.btnstartrecord = QtWidgets.QPushButton(self.widget2)
        ...
        self.btnpreferences = QtWidgets.QPushButton(self.widget2)
        ...
        self.btnhelp = QtWidgets.QPushButton(self.widget2)
