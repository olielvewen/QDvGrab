...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.chkmanualrecord = QtWidgets.QCheckBox(self.gboautomatic)
        self.chkmanualrecord.setObjectName("chkmanualrecord")
        self.verticalLayout_2.addWidget(self.chkmanualrecord)
        self.chkdv2 = QtWidgets.QPushButton(self.gboautomatic)
        self.chkdv2.setMinimumSize(QtCore.QSize(380, 35))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.txtoutputfile.setText(_translate("Dialog", "<html><head/><body><p>Output Folder:</p></body></html>"))
        ...
        self.gboautomatic.setTitle(_translate("Dialog", "Time Capture"))
